...
static void drawspeed(unsigned char num)
{
	...
	sprintf((char*)t,"%02d %02d:%02d %03d KM/H",num,speed_time_rec[num-1][3],speed_time_rec[num-1][4],speed_time_rec[num-1][5]);
	lcd_text12(10,0,(char*)t,17,LCD_MODE_SET);
	//rt_kprintf(t);
	sprintf((char*)t,"%02d %02d:%02d %03d KM/H",num+1,speed_time_rec[num][3],speed_time_rec[num][4],speed_time_rec[num][5]);
	lcd_text12(10,11,(char*)t,17,LCD_MODE_SET);
	//rt_kprintf(t);
	sprintf((char*)t,"%02d %02d:%02d %03d KM/H",num+2,speed_time_rec[num+1][3],speed_time_rec[num+1][4],speed_time_rec[num+1][5]);
	lcd_text12(10,22,(char*)t,17,LCD_MODE_SET);
	//rt_kprintf(t);
	if(index_speednum<=9)
		index_speednum+=3;
	lcd_update_all();
