...
extern u8  SaveCycleSub_1_RdSaveOperate(u16 page_counter,u16 page_offset,u8 *p,u16 length);
extern u8  SaveCycleSub_2_FCS_read_judge(u16 page_counter,u16 page_offset);
