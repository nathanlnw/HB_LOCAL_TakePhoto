...
u8		RemoteIP_aux[4]={113,31,28,101};    //{60,28,50,210}  
u16		RemotePort_aux=8201;  
u8          APN_String[30]="CMNET"; //"CMNET";   //  河北天地通  移动的卡
u8          DomainNameStr[50]="up.gps960.com"; ;  // 域名  天地通up.gps960.com //jt1.gghypt.net
...
u8     JT808_Conf_init( void ) 
  {
        ...
        //   2.  Stuff 
		   ...
		   JT808Conf_struct.Msg_Float_ID=0;   // 消息流水号
                ...
                JT808Conf_struct.Speed_warn_MAX=200;           // 速度最报警门限(小小)
                JT808Conf_struct.Spd_Exd_LimitSeconds=10;  //  超速报警持续时间门限 s(小小)
...
FINSH_FUNCTION_EXPORT(cycle_add, cycle_add ); 
